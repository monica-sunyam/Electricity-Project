...
public class AdminStaticContentService {
    ...
    public AdminStaticContent updateContent(Long id, AdminStaticContent updatedContent) {
        ...
        if (updatedContent.getLogoPath() != null && !updatedContent.getLogoPath().isEmpty()) {
            existingContent.setLogoPath(updatedContent.getLogoPath());
        }
